...
class Linear:
    ...
    def finalize(self, optimizer, optimizer_args=None, suffix = "", *args, **kwargs):
        ...
        with tf.variable_scope(self.name):
            ...
            train_loss = tf.reduce_sum(self._compile_losses(self.sy_train_in, self.sy_train_targ, inc_var_loss=False))
